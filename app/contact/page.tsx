    ...
    <>
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-28 overflow-hidden bg-[#0b1633] text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <Link
            href="/"
            className="group flex items-center gap-2 text-yellow-400 mb-8 sm:mb-12 w-fit"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="text-start">
              ...
              <p className="text-base sm:text-lg text-white/80 mb-8 sm:mb-10 max-w-xl">
            ...
            <div className="relative group w-full max-w-xl mx-auto lg:max-w-none">
              ...
              {/* Form Card */}
              <div className="relative bg-white/10 backdrop-blur-2xl rounded-3xl p-5 sm:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.6)] border border-white/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  {fields.map((field) => (
                    <div key={field.name} className="relative">
                      <input
                        ...
                        required
                        placeholder=" "
                        className="peer w-full px-4 pt-6 pb-2 rounded-xl border border-white/20 bg-white/10 text-white placeholder-transparent focus:ring-2 focus:ring-yellow-400 outline-none transition text-sm sm:text-base"
                      />
                      <label
                        className="absolute left-4 top-2 text-xs sm:text-sm text-white/60 transition-all
                  peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base
                  peer-focus:top-2 peer-focus:text-xs sm:peer-focus:text-sm peer-focus:text-yellow-300"
                      >
                        {field.label}
                      </label>
                    </div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:ring-2 focus:ring-yellow-400 outline-none transition text-sm sm:text-base"
                  />

                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full py-3 rounded-xl font-semibold bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-500 text-black hover:opacity-90 transition text-sm sm:text-base"
                  >
      ...
      <section className="py-12 sm:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          {/* MAP */}
          <div className="rounded-3xl overflow-hidden shadow-2xl hover:scale-[1.01] transition w-full">
            <iframe
