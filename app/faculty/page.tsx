...
export const metadata: Metadata = {
  ...
  description: 'Meet KIITECH faculty members - experienced educators and industry professionals dedicated to student success.',
...
export default function Faculty() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl opacity-95">
              Meet our world-class faculty - experienced educators and industry experts dedicated to your success
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Experienced professors and lecturers committed to delivering excellence in education and mentoring
            </p>
          </div>
              ...
              <Card key={index} className="border-border overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="bg-muted/30 p-3 rounded-lg mb-4">
                    <p className="text-xs font-semibold text-foreground mb-1">Experience: {member.experience}</p>
                    <p className="text-xs font-semibold text-foreground mb-2">Specialization: {member.specialization}</p>
                  </div>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground mb-12 text-center">Faculty Development & Training</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <Card key={index} className="p-8 border-border bg-white hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-bold text-foreground mb-6">{program.title}</h3>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground mb-12 text-center">Research & Innovation</h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: 'Active Research Areas',
                content: 'Our faculty conducts cutting-edge research in AI/ML, IoT, blockchain, renewable energy, and sustainable development.',
              },
              {
                title: 'Patents & Publications',
                content: 'Over 100+ patents filed and 500+ research papers published in reputed national and international journals.',
              },
              {
                title: 'Industry Collaborations',
                content: 'Partnerships with leading tech companies for applied research and technology development projects.',
              },
            ].map((item, index) => (
              <Card key={index} className="p-8 border-border bg-white hover:shadow-lg transition-shadow">
